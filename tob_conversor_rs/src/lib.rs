...
//! - Frame validation for ring files: [`is_valid_main_frame`], [`FrameStats`]
...
pub use tob::{
    CsciType, FieldValue, FrameStats, TO_EPOCH, TobBatchReader, TobHeader,
    ...
    is_valid_main_frame, parse_tob_header, schema_to_ipc_stream_bytes, time_ns_from_frame_header,
